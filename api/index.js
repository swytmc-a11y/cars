// Generated by: esbuild api/_entry.ts --platform=node --format=esm --bundle --packages=external --outfile=api/index.js
...
// server/_core/app.ts
var MIGRATE_SECRET = "L6AqOjaHSDBqYawzAO6fFoOE3wHx33kl";
function createApp() {
  const app2 = express();
  ...
  app2.get("/api/admin/migrate", async (req, res) => {
